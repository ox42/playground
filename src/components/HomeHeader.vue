    ...
    <div class="home-header-left home-header-block">
      <el-dropdown
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item command="bootstrap">Bootstrap 4</el-dropdown-item>
      ...
      githubLogin() {
        notie.select({
          ...
          choices: [{
            ...
            type: 2,
            handler: () => {
              const loginURL = process.env.NODE_ENV === 'development' ? 'http://localhost:4001/login' : 'https://gh-login.cloudapps.io/login'
